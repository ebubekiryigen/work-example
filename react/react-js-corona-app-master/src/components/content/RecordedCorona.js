    ...
    return (
        <div className="flex flex-col items-center justify-center h-full">
            {loading ? <p>Loading...</p> : <>
              ...
              <h1 className="text-6xl text-gray-900 mb-4">Total Deaths : {data?.totalDeaths}</h1>
              <h1 className="text-6xl text-gray-900 mb-4">Total Recovered : {data?.totalRecovered}</h1>
              </>}
    </div>
    )
}
